...
// transport became a proxied one: KeenDNS terminates TLS at the router and connects over the LAN, so
// every connection's peer is the router and sourceAddr returns the same host for everybody.
//

...
/**
 * The key bar's cells, and the guard REQ-0013 Decision 1 exists for.
 *
...
class KeyRowsTest {
    ...
    /**
     * **One row on the bar, one row behind the fold, eight cells each — REQ-0028.**
     *
    ...
    /**
     * **Six cells is the whole point of REQ-0029, so the count is asserted rather than left to drift.**
     *
     ...
     * and eight 47.75, which is what REQ-0028 shipped and what a thumb was never verified against.
     *
     ...
     *
     * The owner's instruction, given while REQ-0028 was being written: *"HIDE, do not delete. Every key
     ...
     *
     * Their report, 2026-08-21, after two weeks of daily use: *"я ни разу, буквально ни разу не
     * использовал Ctrl-A, Ctrl-E, Backspace, стрелочки"*. `killline` is the eighth and is a judgement
    ...
    fun `the folded keys are the ones the owner never pressed`() {
        ...
        assertEquals(
            setOf(
                ...
                "killline",
                // **Not folded for being unused - folded because they got a gesture.** REQ-0029: an

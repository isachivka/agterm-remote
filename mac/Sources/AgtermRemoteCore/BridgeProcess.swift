...
public final class BridgeProcess: @unchecked Sendable {
    ...
    func arguments() -> [String] {
        ...
        // No scheme flag and no on-link flag: the bridge serves TLS and plain HTTP on its one port,
        // decided per connection, and the phone tries TLS first. Nothing about the network is
        // described here, because nothing about it was ever observable from here.
